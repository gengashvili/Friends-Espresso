...
object UiElementsPage : Page<UiElementsPage>() {
    ...
    val eventStatus: Matcher<View> by lazy { withId(R.id.last_event_status) }
    val defaultContent: Matcher<View> by lazy { withId(R.id.et_contentDesc) }
    ...
    val radioButtonInvisible: Matcher<View> by lazy { withId(R.id.radio_invisible) }
